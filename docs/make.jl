...
DocMeta.setdocmeta!(PowerPlotsMakie, :DocTestSetup, :(using PowerPlotsMakie); recursive = true)
...
makedocs(;
    modules = [PowerPlotsMakie],
    authors = "Stefan de Lange <langestefan@msn.com>",
    repo = "https://github.com/langestefan/PowerPlotsMakie.jl/blob/{commit}{path}#{line}",
    sitename = "PowerPlotsMakie.jl",
    format = Documenter.HTML(; canonical = "https://langestefan.github.io/PowerPlotsMakie.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/langestefan/PowerPlotsMakie.jl")
